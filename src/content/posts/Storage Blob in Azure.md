...
tags: ['Azure Blob Storage', 'Object Storage', 'Hot Cold Archive', 'Cloud Storage']
image: /assets/img/posts/az-strblb.png
toc: true
categories: ['Azure & Cloud']
description: "Overview of Azure Blob storage tiers, container structures, and access tiers for unstructured data."
...
![alt text](/assets/img/posts/blob/image.png)

![alt text](/assets/img/posts/blob/image-1.png)

On the Advanced tab of the Create a storage account blade, fill in the following information.

![alt text](/assets/img/posts/blob/image-4.png)
...
![alt text](/assets/img/posts/blob/image-5.png)

I have created a container named "data" here

![alt text](/assets/img/posts/blob/image-2.png)

Click on the container and upload anything. I have uploaded an image.

![alt text](/assets/img/posts/blob/image-3.png)
...
![alt text](/assets/img/posts/blob/image-6.png)
